...
import 'package:AIApp/audiowaveforms/painters/recorder_wave_painter.dart';
...
class _AudioWaveformsState extends State<AudioWaveforms> {
          ...
          child: RepaintBoundary(
            child: CustomPaint(
              ...
              painter: RecorderWavePainter(
                ...
                updateFrequency: const Duration(seconds: 1).inMilliseconds /
                    RecorderController.updateFrequency.inMilliseconds,
  ...
  void _pushBackWave() {
    ...
    widget.recorderController.totalBackDistance =
        widget.recorderController.totalBackDistance +
            Offset(widget.waveStyle.spacing, 0.0);
