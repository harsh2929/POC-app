...
class MarkupPrompt extends StatelessWidget {
  ...
  const MarkupPrompt(
      {super.key, required this.prompt, required this.emphasized});
  ...
  Widget build(BuildContext context) {
        ...
        .expand((e) => [
              normalizedEmphasized.contains(_normalize(e))
                  ? TextSpan(
                      ...
                      style: tt(context)
                          .bodySmall!
                          .copyWith(backgroundColor: C.front.withAlpha(128)))
                  : TextSpan(text: e),
              const TextSpan(text: " ")
            ])
    ...
    return RichText(
      text:
          TextSpan(text: "", style: tt(context).bodySmall, children: children),
      maxLines: 5,
    );
  }
}
