...
import 'package:AIApp/audiowaveforms/audio_waveforms.dart';
import 'package:AIApp/audiowaveforms/base/wave_style.dart';
import 'package:AIApp/settings.dart';
import 'package:AIApp/state/app_state.dart';
import 'package:AIApp/state/deepgram.dart';
...
import 'package:AIApp/widget/asmall_button.dart';
import 'package:AIApp/widget/bottom_round_card.dart';
import 'package:AIApp/widget/circle_button.dart';
import 'package:AIApp/widget/input_text.dart';
import 'package:AIApp/widget/progress.dart';
import 'package:AIApp/widget/prompt_box/mic_button.dart';
...
class PromptBox extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final currentPrompt =
        ref.watch(PromptNotifier.provider.select((p) => p.current));
    final promptUpdating =
        ref.watch(PromptNotifier.provider.select((p) => p.updating));
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            AnimatedSlide(
                              ...
                              child: AnimatedScale(
                                ...
                                curve: CV.normal,
                                child: InkWell(
                                  onTap: isTextInput.value
                                      ? () => isTextInput.value = false
                                      : null,
                                  child: MicButton(
                                      onStart: () => deepgramNotifier
                                          .startRecord(inputController.text),
                                      onStop: () =>
                                          deepgramNotifier.stopRecord(),
                      ...
                      Text(
                        ...
                        style: tt(context)
                            .bodyLarge!
                            .copyWith(color: C.grey3, fontSize: 10),
                      )
                    ],
                  ),
                ),
