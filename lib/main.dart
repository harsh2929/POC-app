...
import 'package:AIApp/app/app.dart';
...
_dioCacheSetup() async {
  ...
  dioCacheOptions = CacheOptions(
    ...
    keyBuilder: (request) {
      ...
      return "${request.uri.toString()}${stringify(request.data)}"
          .hashCode
          .toString();
    },
...
main() async {
  ...
  SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
      statusBarColor: Color.fromARGB(0, 190, 122, 122), // Color for Android
      statusBarBrightness:
