...
import 'package:AIApp/screens/refine/refine_screen.dart';
...
import 'package:AIApp/widget/prompt_box/prompt_box.dart';
import 'package:AIApp/widget/recipe_title.dart';
import 'package:AIApp/widget/replicate_image.dart';
import 'package:AIApp/widget/texts/italic_title.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          if (appState == AppState.refine)
            const Flexible(child: RefineScreen()),
        ],
      ),
    );
  }
