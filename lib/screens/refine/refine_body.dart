...
import 'package:AIApp/screens/old_refine/one_category.dart';
...
import 'package:AIApp/state/top_scroll_block.dart';
          ...
          children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ASmallButton(
                      ...
                      onPressed: () {
                        final treeNotifier =
                            ref.read(TreeNotifier.provider.notifier);
                        treeNotifier.cleanup();
                        appStateNotifier.prefetchTree(
                            prompt: prompt, userDefaults: false);
            ...
            Expanded(
              child: PageView(
                ...
                onPageChanged: (page) {
                  final topScrollBlock =
                      ref.read(TopScrollBlockNotifier.provider);
                  if (topScrollBlock) {
                    return;
                  }
            ...
            if (!categoryFetched)
              const RefineProgress(
                  'Fetching more options to fine-tune your prompt. Hang tight!'),
          ],
        ),
      ),
    );
