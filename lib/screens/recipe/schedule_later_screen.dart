...
import 'package:AIApp/screens/recipe/recipe_compact_card.dart';
    ...
    return Scaffold(
      ...
      children: [
              ...
              Row(
                ...
                children: [
                  Text("Schedule for later",
                      style: tt(context).bodyLarge!.copyWith(color: C.black)),
                  ACloseButton(
                      onPressed: appStateNotifier.recipeDetail, color: C.black),
                ],
              ),
        ...
        const OptionRow(
            selected: false,
            disabled: true,
            title: "Block meal time in my calendar",
            padded: true),
        const OptionRow(
            selected: false,
            disabled: true,
