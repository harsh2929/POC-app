...
import 'package:AIApp/amplifyconfiguration.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        const Padding(
                          ...
                          child: LargeBody(
                              "A place for personalised, mouthwatering food suggestions that perfectly fit your lifestyle."),
                        ),
                        const Spacer(flex: 1),
                        SizedBox(
                            width: 254,
                            child: AButton(
                                ...
                                onPressed: startupNotifier.signup)),
                        ...
                        SizedBox(
                            ...
                            child: AButton(
                                ...
                                outline: true,
                                inverted: true,
                                onPressed: startupNotifier.login)),
