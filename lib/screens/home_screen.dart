...
import 'package:AIApp/screens/error_screen.dart';
import 'package:AIApp/screens/start_screen/start_screen.dart';
import 'package:AIApp/screens/warning/warning_screen.dart';
...
class HomeScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    setup() async {
      ...
      final accessTokenNotifier =
          ref.read(AccessTokenNotifier.provider.notifier);
    ...
    useEffect(() {
      Segment.track(
          eventName: 'Navigate', properties: {'screen': appState.name});
      return null;
    }, [appState]);
    ...
    return Stack(
      children: [
        ...
        if (error != null && !error.contains("was cancelled"))
          const ErrorScreen(),
      ],
    );
  }
