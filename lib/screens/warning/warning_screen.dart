              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    ACloseButton(
                        onPressed: warningNotifier.hide, color: C.white),
                  ],
                ),
                ...
                ListView(
                  ...
                  children: [
                    Text(_warningText,
                        style:
                            tt(context).titleMedium!.copyWith(color: C.white)),
                    ...
                    const SizedBox(height: 16),
                    const LinkButton(
                        "2. Lindshield, B. (2018). Kansas State University Human Nutrition Flexbook.",
                        link:
                            "https://open.umn.edu/opentextbooks/textbooks/kansas-state-university-human-nutrition-flexbook"),
                  ],
                ),
              ],
            )),
