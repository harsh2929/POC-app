...
import 'package:AIApp/model/correct_prompt_request.dart';
import 'package:AIApp/model/correct_prompt_response.dart';
import 'package:AIApp/model/prompt.dart';
...
class PromptNotifier extends StateNotifier<Prompt> {
  ...
  static final provider =
      StateNotifierProvider<PromptNotifier, Prompt>(PromptNotifier.new);

  PromptNotifier(this.ref)
      : super((const Prompt(
            original: "",
            current: "",
            changed: [],
  ...
  reset(String newPrompt) => state = Prompt(
      original: newPrompt,
      changed: [],
      current: newPrompt,
      updating: false,
